...
class Settings(Model):
    _name = "lazada.settings"
    _fields = {
        "default_uom_id": fields.Many2One("uom","Default UoM"),
        "order_auto_copy_to_sale": fields.Boolean("Auto Copy Lazada Order to Sale Order when Syncing"),
        "order_auto_copy_to_picking": fields.Boolean("Auto Copy Lazada Order to Goods Issue when Syncing"),
        ...
        "enable_webhook": fields.Boolean("Enable Webhook"),
