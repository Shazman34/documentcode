...
class Picking(Model):
    ...
    _fields = {
        ...
        "shopee_logistics_channel_id": fields.Integer("Logistic Channel ID"),
        "shopee_service_code": fields.Char("Service Code"),
        "shopee_first_mile_name": fields.Char("First Mile Name"),
        "shopee_last_mile_name": fields.Char("Last Mile Name"),
        "shopee_zone": fields.Char("Zone"),
        "shopee_lane_code": fields.Char("Lane Code"),
        "shopee_warehouse_address": fields.Text("Warehouse Address"),
        "shopee_warehouse_id": fields.Char("Warehouse ID"),
        "shopee_first_recipient_sort_code": fields.Char("First Recipient Sort Code"),
        "shopee_second_recipient_sort_code": fields.Char("Second Recipient Sort Code"),
        "shopee_third_recipient_sort_code": fields.Char("Third Recipient Sort Code"),
        "shopee_first_sender_sort_code": fields.Char("First Sender Sort Code"),
        "shopee_second_sender_sort_code": fields.Char("Second Sender Sort Code"),
        "shopee_third_sender_sort_code": fields.Char("Third Sender Sort Code"),
        "shopee_return_first_sort_code": fields.Char("Return First Sort Code"),
    }
