...
class Settings(Model):
    ...
    _fields = {
        ...
        "order_auto_copy_to_invoice": fields.Boolean("Auto Copy Shopee Order to Invoice when Syncing"),
        "order_auto_post_invoice": fields.Boolean("Auto Post Invoice When Created"),
